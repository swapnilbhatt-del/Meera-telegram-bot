...
// Returns up to 5 { title, source, link, published } items, newest first. Never throws:
// news is optional context, so any failure returns [] and drafting carries on without it.
