...
- Work information from at least one headline into the post: the one most relevant to the note's point, plus any others that genuinely help. Skip headlines that aren't relevant.
...
- After the post, add one final line in exactly this form, listing the numbers of the headlines you used: "USED: 1, 3".`;
}
